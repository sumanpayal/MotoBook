        ...
        <MainFrame isHeader title='Invoice History' isNotifications={false}>
            <View style={styles.main}>
                <View style={{ gap: scaleHeightPX(16), marginBlock: scaleHeightPX(24) }}>
                    <CustomDate label='Select By Month' onPress={(value: any) => setStartDate(value)} value={formatDate(startDate, 'yearMonth')} minimumDate={null} placeholder='YYYY-MM' isFormatted={false} disabled />
                </View>
